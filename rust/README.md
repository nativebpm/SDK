...
*DefaultApi* | [**get_smtp_config**](docs/DefaultApi.md#get_smtp_config) | **GET** /api/smtp-config | Get SMTP configuration
*DefaultApi* | [**get_user_groups**](docs/DefaultApi.md#get_user_groups) | **GET** /api/users/{username}/groups | Get user groups
